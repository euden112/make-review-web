...
def _build_map_prompt(*, chunk_text: str, deterministic_candidate: str) -> str:
    return (
        ...
        "Keep output compact: max 8 evidence_items, max 4 quote_candidates, max 5 aspects.\n"
        "Each evidence item: {review_id,source,aspect,polarity,detail,snippet}.\n"
...
def _build_map_retry_prompt(*, deterministic_candidate: str) -> str:
    return (
        ...
        "Each evidence_items entry must keep review_id, source, aspect, polarity, detail, snippet.\n"
